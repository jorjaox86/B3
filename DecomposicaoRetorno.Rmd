...
pontuação ESG L abaixo de 3, ESG H acima de 7, ESG L abaixo de 4 e ESG H acima de 6;
pontuação máxima: 10;
...
```{r}
   ...
   tb6 <- dcast(tb6,VARF~CASE,value.var = "Valor")
