...
```{r}
   ...
   kable(tb2[c(1:4),2:6],align=c(rep('c', 5)))
...
```{r}
   # dtICCESG_0 <- Tab3DeltaIndex(dtICC_D,esgTEMP,ano_0)
   # dtICCESG_1 <- Tab3DeltaIndex(dtICC_D,esgTEMP,ano_0)
   tb3 <- betasTab3(dadosn, dtICCESG,ano_0)
   rownames(tb3) <- tb3$VARF
   # kable(tb3)
   kable(tb3[c(7,3,11,5,1,13,14,15,16),2:4],align=c(rep('c', 5)))
...
```{r}
   ...
   kable(tb5[c(7,3,11,5,1,13,14,15,16),2:4],align=c(rep('c', 5)))
```
...
```{r}
   ...
   kable(tb6[c(7,3,11,5,1,13,14,15,16),2:6],align=c(rep('c', 5)))
...
```{r}
   tb2
   w <- rbind(BetaNames,BetaNamesP)
   tb7 <- tab7Build(dadosn, ano_0)
   row.names(tb7) <- tb7$VARF
   kable(tb7[c(7,3,11,5,1,13,14,15,16),2:3],align=c(rep('c', 5)))
